...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .app-btn {
              background: #4a5568; color: #ffff; padding:1em; cursor: pointer;
            }
            .app-btn:hover {
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-3 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                  <div class="grid grid-cols-1">
                      <button id="queueJob" data-href="{{ route('addUsers') }}" type="button" class="app-btn">
                        Process Queue
                      </button>
                    </div>
                </div>
